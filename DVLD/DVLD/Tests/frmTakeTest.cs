...
namespace DVLD.Tests
{
   public partial class frmTakeTest : Form
   {
      ...
      private clsTestType.enTypeTest _TestType;

      private int _TestID = -1;
      private clsTest _Test;


      public frmTakeTest(int AppointmentID, clsTestType.enTypeTest TestType)
      {
         InitializeComponent();
      ...
      private void btnSave_Click(object sender, EventArgs e)
      {
         ...
         _Test.CreatedByUserID = clsGlobal.CurrnetUser.UserID;
